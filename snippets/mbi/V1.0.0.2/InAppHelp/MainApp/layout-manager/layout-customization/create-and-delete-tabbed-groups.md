...
2. Right-click any of the selected layout items and select **Group** from the context menu:
	...
	![EU_XtraLayout_LayoutControl_SelectedItems_Menu](../../../MainApp/images/img7643.png)
	...
	![EU_XtraLayout_LayoutControl_NewGroup](../../../MainApp/images/img7647.png)
3. Right-click the group's caption and select **Create Tabbed Group**.
	
	![EU_XtraLayout_LayoutControl_NewGroup_ContextMenu](../../../MainApp/images/img7649.png)
	
	This creates a tab control with one tab displaying the contents of the original group.
	
	![EU_XtraLayout_LayoutControl_NewGroup_NewTabbedGroup](../../../MainApp/images/img7650.png)
...
![EU_XtraLayout_LayoutControl_Group_ContextMenu](../../../MainApp/images/img7648.png)
...
1. Right-click a tab header and select **Rename**:
	...
	![EU_XtraLayout_LayoutControl_NewTab_ContextMenu](../../../MainApp/images/img7651.png)
...
![EU_XtraLayout_LayoutControl_TabbedGroup_ContextMenu](../../../MainApp/images/img7652.png)
...
![EU_XtraLayout_LayoutControl_TabbedGroup_Disassemble](../../../MainApp/images/img7653.png)
