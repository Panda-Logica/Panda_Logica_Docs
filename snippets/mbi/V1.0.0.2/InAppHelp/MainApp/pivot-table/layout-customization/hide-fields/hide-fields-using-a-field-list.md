...
* Drag a field away from the header panel, until the cursor changes its image to the big 'X'. Then drop the header.
	...
	![EU_XtraPivotGrid_DragField_HideCursor](../../../../MainApp/images/img7596.png)
* Drag and drop a field onto the Field List form.
	
	![EU_XtraPivotGrid_DragFieldToCustomizationForm](../../../../MainApp/images/img7597.png)
...
![EU_XtraPivotGrid_FieldListHiding](../../../../MainApp/images/img13519.png)
