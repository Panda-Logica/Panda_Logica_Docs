...
If you are printing the Grid dashboard item using the [Print Preview](../../../dashboard-designer/ui-elements/print-preview.md), you can customize the following options (via the **Options** button) before printing.

![Grid_PrintingOptionsDialog](../../../../images/img22929.png)
...
* **Fit to Page Width** - Specifies whether the size of the grid dashboard item is changed according to the width of the exported page.
...
![Grid_PDFExportOptionsDialog](../../../../images/img22930.png)
